    ...
    return (
        <div className="mb-4">
            ...
            <select
                ...
                className="mt-1 block w-40 pl-3 py-2 text-center border text-base border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
