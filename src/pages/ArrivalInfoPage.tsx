...
const ArrivalInfoPage: React.FC = () => {
    ...
    // timetable 전처리
    const fillStationTableData = useCallback(
        (arrivalData: ArrivalInfo, timetable: StationTableData, stationID: string) => {
    ...
    const fetchArrivalInfo = useCallback(
        async (stationID: string, timetableData: StationTableData) => {
            ...
            if (timetableData) arrivalData = fillStationTableData(arrivalData, timetableData, stationID);
            setArrivalInfo(arrivalData);
            setLoading(false);
        },
        [fillStationTableData]
    );
    ...
    const handleStationChange = useCallback(
        ...
        [selectedLine, loading, fetchArrivalInfo]
    );
